...
export default function HorizontalScroll() {
  ...
  return (
    ...
    {/* relative flex h-[500px] overflow-x-scroll overflow-y-hidden w-11/12   md:w-3/4 lg:w-[1/2] xl:w-[40%] mx-auto items-center bg-blue-400 whitespace-nowrap scroll-smooth */}
      <div className='w-11/12   md:w-3/4 lg:w-[1/2] xl:w-[40%] mx-auto items-center  shadow-md rounded-md'>
        <div ref={carouselRef} className="relative flex h-[500px] w-full overflow-hidden    ">
        ...
        <div
          id="slide2"
          className="absolute top-0 left-[70%] w-3/4 md:w-[60%] mx-auto h-full flex items-center justify-center  rounded-2xl"
        >
        ...
        <div
          id="slide3"
          className="absolute top-0 left-[130%] w-3/4 md:w-[60%] mx-auto h-full flex items-center justify-center  rounded-2xl"
        >
          <div className="h-[400px] w-3/4 bg-white rounded-xl  overflow-hidden flex items-center justify-center">
            <div className="relative h-full w-full">
              <Image
        ...
        <div
          id="slide4"
          className="absolute top-0 left-[190%] w-3/4 md:w-[60%] mx-auto h-full flex items-center justify-center  rounded-2xl"
        >
          <div className="h-[400px] w-3/4 bg-white rounded-xl  overflow-hidden flex items-center justify-center">
            <div className="relative h-full w-full">
              <Image
      ...
      {/* Slide 5 */}
        ...
        <div id="slide5" className="absolute top-0 left-[260%] flex items-center justify-center w-3/4 md:w-[60%] lg:w-[50%]  h-full">
